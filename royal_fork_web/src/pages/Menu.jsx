...
const menuData = [
  ...
  { id: 8, category: 'Starters', name: 'Falafel de Luxe', price: 14, description: 'Boulettes de pois chiches aux herbes fraîches, sauce tahini premium.', image: `${BASE}assets/falafel_de_luxe.png` },
