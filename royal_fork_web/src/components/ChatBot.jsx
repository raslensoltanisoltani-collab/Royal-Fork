...
const ChatBot = () => {
  ...
  const getBotResponse = (query) => {
    ...
    if (query.includes('objectif') || query.includes('but') || query.includes('avenir') || query.includes('expansion') || query.includes('goal') || query.includes('future') || query.includes('vision') || query.includes('أهداف') || query.includes('مشروع') || query.includes('اهذاف') || query.includes('مرحلة') || query.includes('انتشار')) {
